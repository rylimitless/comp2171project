...
enum Category { textbook, electronics, furniture, clothing, school, other, None }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
          ...
          Center( // Center the image/placeholder
            child: Container(
              ...
              child: isUrlValid
                ...
                : Center( // Display placeholder if URL is invalid
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.image_not_supported, size: 40, color: Colors.grey[600]),
                        SizedBox(height: 8),
                        Text('Invalid image URL', style: TextStyle(color: Colors.grey[600])),
                      ],
                    ),
                  ),
            ),
     ...
     FTextField(
            ...
            hint: description.isNotEmpty ? description : '(No description provided)', // Show placeholder if empty
           ...
           FButton(
                ...
                FButton(
                    ...
                    onPress: () async{
                      ...
                      final Products prod = Products(prodName, url, "", description, price, prodCondition, "", "");
                      Provider.of<AppProvider>(context, listen:false).createListing(prod, category);
                    },

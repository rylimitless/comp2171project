...
class Products {
  ...
  Products(this.name,this.url,this.category_id,this.description,this.price, this.condition,this.seller_name,this.seller_id);
}
...
class AppProvider extends ChangeNotifier {
  ...
  for(var record in records){
    ...
    final seller_id = record.getStringValue('seller');
     ...
     final product = Products(name, url, category_id, description, price,condition,seller_name,seller_id);
  ...
  try {
    final body = <String, dynamic>{
      "title": name,
      "img": url,
      "category_id": categoryId, // Ensure this category ID exists in your 'category' collection
    ...
    Logger().e('Error creating product in PocketBase: $e', stackTrace: stackTrace);
